...
export function Feedback() {
  return (
    <section className="flex flex-col items-center justify-center p-2 xl:py-12 xl:px-4 xl:bg-[url('/assets/img/consult.webp')] xl:bg-contain xl:bg-no-repeat xl:bg-right xl:mt-8">
        ...
        <div className="p-5 flex flex-col gap-2 xl:gap-4">
          ...
          <form>
            <div className="grid xl:grid-cols-2 gap-4 mb-5">
              ...
              <div>
                <label className="hidden">Номер телефона</label>
                <input
                  type="tel"
            ...
            <div className="grid xl:grid-cols-2 gap-4 mb-5">
              <div>
                <label className="hidden">Год покупки</label>
                <input
                  type="number"
              ...
              <div>
                <label className="hidden">Пробег</label>
                <input
                  type="number"
                  placeholder="Пробег"
                  className="w-full px-3 py-3 border border-gray-300 rounded-lg text-sm outline-none focus:border-red-900 transition-colors"
            ...
            <div className="mb-5">
              <label className="hidden">Модель</label>
              <select
